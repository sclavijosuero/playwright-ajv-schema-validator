...
- [playwright-ajv-schema-validator](#playwright-ajv-schema-validator)
  ...
  - [PRESENTATION OF RESULTS](#presentation-of-results)
    - [Used with **`pw-api-plugin`**](#used-with-pw-api-plugin)
    - [Used as Standalone Plugin with Playwright Standard Requests](#used-as-standalone-plugin-with-playwright-standard-requests)
    - [Define Custom Styles for Schema Errors in Your Tests](#define-custom-styles-for-schema-errors-in-your-tests)
    - [Disable Schema Validation](#disable-schema-validation)
    - [Attach Schema Validation Details in HTML Report](#attach-schema-validation-details-in-html-report)
